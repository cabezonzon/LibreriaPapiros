...
Validar v = new Validar();    
 ...
 JDialog viewer4 = new JDialog(new JFrame(),"Estado de cuenta",true);
    ...
    public ABMUsuario() {
        ...
        mostrardatos("");
        this.setTitle("Gestion de los datos de los Usuarios del sistema");
        btnmodificar.setEnabled(false);
       
        
        String [] turno = {"admin","vendedor"};
        cbotipo.setModel(new javax.swing.DefaultComboBoxModel(turno));
    }
     void mostrardatos(String valor) {
        ...
        repositorioUsuario.getInstancia().rellenarModeloUsuario(modelo, valor);
        jTableProducto.setModel(modelo);
  ...
  private boolean validar(){
    try{
       if ("".equals(txtNick.getText())) {
            JOptionPane.showMessageDialog(null, "El campo nick está vacio");
            return false;
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtNick, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 190, 140, -1));
        ...
        getContentPane().add(txtcontra, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 220, 140, -1));
        ...
        getContentPane().add(btnGuardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 310, 40, 40));

        jLabel11.setText("Buscar");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 350, -1, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 380, 630, 200));
        ...
        getContentPane().add(btnmodificar, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 310, 40, 40));
        ...
        getContentPane().add(txtbuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 330, 90, -1));

        btnMostrarUsuario.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/show all.png"))); // NOI18N
        ...
        getContentPane().add(btnMostrarUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 310, 40, 40));
        ...
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 350, -1, -1));
        ...
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 190, -1, -1));

        cbotipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        getContentPane().add(cbotipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 250, 140, -1));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
       if(validar()){
        ...
        pro.setNick(txtNick.getText());
        pro.setContra(txtcontra.getText());
       pro.setTipoUsuario((String) cbotipo.getSelectedItem());

        repositorioUsuario rep = repositorioUsuario.getInstancia();
        rep.guardarUsuario(pro);
        JOptionPane.showMessageDialog(null, "Se guardo el nuevo Usuario con exito");
           mostrardatos("");
                   txtNick.setText("");
                   txtcontra.setText("");
    ...
    private void btnmodificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnmodificarActionPerformed
        ...
        pro.setContra(txtcontra.getText());
        pro.setTipoUsuario((String) cbotipo.getSelectedItem());
        pro.setIdUsuario(Integer.parseInt((String) tm.getValueAt(jTableProducto.getSelectedRow(), 0)));
        repositorioUsuario rep = repositorioUsuario.getInstancia();
        rep.guardarUsuario(pro);
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        ...
        if (fila >= 0) {
            txtNick.setText(jTableProducto.getValueAt(fila, 1).toString());
            txtcontra.setText(jTableProducto.getValueAt(fila, 2).toString());
            cbotipo.setSelectedItem(jTableProducto.getValueAt(fila, 3).toString());
