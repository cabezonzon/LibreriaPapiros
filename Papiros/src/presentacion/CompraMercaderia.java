 ...
 * @author Usuario
 */
public class CompraMercaderia extends javax.swing.JFrame {
    ...
    /**
     * Creates new form CompraMercaderia
     */
    public CompraMercaderia() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 150, 40, 40));
        ...
        jTableCompra.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Nombre", "Precio", "Descripcion", "Cantidad"
            }
        ) {
        ...
        jTableCompra.addKeyListener(new java.awt.event.KeyAdapter() {
            ...
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTableCompraKeyTyped(evt);
            }
        });
        jScrollPane1.setViewportView(jTableCompra);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 230, 500, 100));

        btnven.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/save.png"))); // NOI18N
        ...
        getContentPane().add(btnven, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 350, 40, 40));
        ...
        getContentPane().add(dateControl, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 180, 130, -1));
    ...
    private void jTableCompraKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTableCompraKeyTyped

    }//GEN-LAST:event_jTableCompraKeyTyped
    ...
    private void btnvenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnvenActionPerformed
        ...
        List<movimientoStock> lineas = new ArrayList<movimientoStock>();
        repositorioMovimientoStock repp = repositorioMovimientoStock.getInstancia();

        for (int i = 0; i < CompraMercaderia.jTableCompra.getRowCount(); i++) {
            codPro = CompraMercaderia.jTableCompra.getValueAt(i, 0).toString();
            cantidad = CompraMercaderia.jTableCompra.getValueAt(i, 4).toString();
            Integer obtenerCantidad = rep.obtenerCantidad2(modelo, codPro);
            if (obtenerCantidad == null) {
                obtenerCantidad = 0;
            }
            sto.setCantidad(obtenerCantidad + Integer.parseInt(cantidad));
            sto.setIdProducto(Integer.parseInt(codPro));
            rep.guardarStock(sto);
            mov.setFecha(new java.sql.Date(dateControl.getDate().getTime()));
            mov.setIdProducto(Integer.parseInt(codPro));
            mov.setCantidad(Integer.parseInt(cantidad));
            repp.guardarCompra(mov);
           
        }
         JOptionPane.showMessageDialog(null, "Compra de nueva mercaderia realizada con exito");
        DefaultTableModel modeloo = (DefaultTableModel) jTableCompra.getModel();
        int a = jTableCompra.getRowCount() - 1;
        int i;
        for (i = a; i >= 0; i--) {
            modeloo.removeRow(i);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CompraMercaderia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CompraMercaderia().setVisible(true);
            }
        });
    }
