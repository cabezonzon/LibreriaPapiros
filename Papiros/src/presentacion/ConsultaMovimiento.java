...
public class ConsultaMovimiento extends javax.swing.JFrame {
    ...
    public ConsultaMovimiento() {
        ...
        jdfec1.setDate(mydate);
        jdfec2.setDate(mydate);
        jdfec1.setFormats(new SimpleDateFormat("yyyy-MM-dd"));
        jdfec2.setFormats(new SimpleDateFormat("yyyy-MM-dd"));
    }
    ...
    private void initComponents() {
        ...
        setTitle("Consulta de movimientos de caja");
        setAutoRequestFocus(false);
        getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel11.setText("Buscar");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 190, -1, -1));
        getContentPane().add(jdfec2, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 170, -1, -1));
        getContentPane().add(jdfec1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 170, -1, -1));
        ...
        getContentPane().add(btnBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 150, 40, 40));
        ...
        jScrollPane1.setViewportView(jTableMovimiento);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 210, 640, 310));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/background.png"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 670, -1));
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        modelo.addColumn("NUMERO_MOVIMIENTO");
        modelo.addColumn("RAZON");
        modelo.addColumn("ENTRADA_SALIDA");
        modelo.addColumn("MONTO");
        modelo.addColumn("APERTURA_CAJA");
        modelo.addColumn("USUARIO");
        jTableMovimiento.setModel(modelo);

        repositorioMovimiento.getInstancia().rellenarModeloMovimiento(modelo,  fec1, fec2);
        jTableMovimiento.setModel(modelo);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaMovimiento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
